package bistu.rookie.u_nity.androidproject_20;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void DeleteDialog(final String strId){
        new AlertDialog.Builder(this).setTitle("DELETE Words").setMessage("Are you sure?").setPositiveButton("Sure", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialogInterface, int i) {
                ...
                .setPositiveButton("Sure", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        ...
                        if(items.size()>0) {
                            ...
                            Toast.makeText(MainActivity.this,"Cannot find",Toast.LENGTH_LONG).show();
